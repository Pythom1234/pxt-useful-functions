...
namespace useful {
    ...
    //% block="comment $c||(run code $run)" block.loc.cs="komentář $c||(spouštět kód $run)" color=#707070 weight=99 handlerStatement run.shadow="toggleYesNo" expandableArgumentMode="enabled" run.defl=true
